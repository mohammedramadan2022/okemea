...
Route::prefix('page-layouts')->group(function () {
    ...
    Route::view('semi-dark', 'page-layouts.semi-dark')->name('pages-semi-dark');
    Route::view('semi-dark-rtl', 'page-layouts.semi-dark-rtl')->name('pages-semi-dark-rtl');
    ...
    Route::view('compact-dark-rtl-layout', 'page-layouts.compact-dark-rtl-layout')->name('pages-compact-dark-rtl-layout');
});
...
Route::view('landing', 'pages.landing-page')->name('landing-page');
