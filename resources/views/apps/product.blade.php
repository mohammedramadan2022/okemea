                                 ...
                                 <div class="owl-carousel owl-theme" id="testimonial">
                                    <div class="item">
                                       <div class="product-box row">
                                          <div class="product-img col-md-6"><img class="img-fluid" src="{{asset('assets/images/ecommerce/01.jpg')}}" alt="" data-original-title="" title=""></div>
                                       ...
                                       <div class="product-box row">
                                          <div class="product-img col-md-6"><img class="img-fluid" src="{{asset('assets/images/ecommerce/02.jpg')}}" alt="" data-original-title="" title=""></div>
                                          <div class="product-details col-md-6 text-left">
                                             <span><i class="fa fa-star font-warning mr-1"></i><i class="fa fa-star font-warning mr-1"></i><i class="fa fa-star font-warning mr-1"></i><i class="fa fa-star font-warning mr-1"></i><i class="fa fa-star font-warning"></i></span>
                                             <p class="mb-0">Fancy Shirt</p>
                                             <div class="product-price">$100.00</div>
                                       ...
                                       <div class="product-box row">
                                          <div class="product-img col-md-6"><img class="img-fluid" src="{{asset('assets/images/ecommerce/03.jpg')}}" alt="" data-original-title="" title=""></div>
                                          <div class="product-details col-md-6 text-left">
                                             <span><i class="fa fa-star font-warning mr-1"></i><i class="fa fa-star font-warning mr-1"></i><i class="fa fa-star font-warning mr-1"></i><i class="fa fa-star font-warning mr-1"></i><i class="fa fa-star font-warning"></i></span>
                                             <p class="mb-0">Fancy Shirt</p>
                                             <div class="product-price">$100.00</div>
