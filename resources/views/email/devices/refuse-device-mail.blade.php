            ...
            <table class="o_block-lg" width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" style="max-width: 800px;margin: 0 auto;">
                ...
                <tr>
                    <td class="o_bg-dark o_px o_py-md o_br-t o_sans o_text" align="center" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;background-color: #242b3d;border-radius: 4px 4px 0px 0px;padding-left: 16px;padding-right: 16px;padding-top: 24px;padding-bottom: 24px;">
                        <p style="margin-top: 0px;margin-bottom: 0px;"><a class="o_text-white" href="" style="text-decoration: none;outline: none;color: #ffffff;"><img src="{{asset('web-assets/Images/Logo.png')}}" width="136" height="36" alt="Okema" style="max-width: 136px;-ms-interpolation-mode: bicubic;vertical-align: middle;border: 0;line-height: 100%;height: auto;outline: none;text-decoration: none;"></a></p>
                    </td>
                </tr>
                </tbody>
            </table>
                ...
                <tr>
                    <td class="o_bg-ultra_light o_px-md o_py-xl o_xs-py-md" align="center" style="background-color: #ebf5fa;padding-left: 24px;padding-right: 24px;padding-top: 64px;padding-bottom: 64px;">
                        ...
                        <div class="o_col-6s o_center o_sans o_text-md o_text-light" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 19px;line-height: 28px;max-width: 584px;color: #82899a;text-align: center;">
                            <table class="o_center" role="presentation" cellspacing="0" cellpadding="0" border="0" style="text-align: center;margin-left: auto;margin-right: auto;">
                                ...
                                <tr>
                                    ...
                                    <td rowspan="2" class="o_sans o_text o_text-secondary o_px o_py" align="center" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;color: #424651;padding-left: 16px;padding-right: 16px;padding-top: 16px;padding-bottom: 16px;">
                                        <img src="{{asset('web-assets/Images/Logo.png')}}" width="48" height="48" alt="" style="max-width: 48px;-ms-interpolation-mode: bicubic;vertical-align: middle;border: 0;line-height: 100%;height: auto;outline: none;text-decoration: none;">
                                    </td>
                                    <td class="o_bb-primary" height="40" width="32" style="border-bottom: 1px solid #126de5;">&nbsp; </td>
                                </tr>
                                <tr>
                            ...
                            <h2 class="o_heading o_text-dark o_mb-xxs" style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 4px;color: #242b3d;font-size: 30px;line-height: 39px;">عذرا تم رفض جهازك</h2>
                            <p style="margin-top: 0px;margin-bottom: 0px;">تم رفض جهازك برجاء التواصل مع الاداره.
                            </p>
                        </div>
                        <!--[if mso]></td></tr></table><![endif]-->
                    </td>
...
{{--                            <p style="margin-top: 0px;margin-bottom: 0px;">مرحبًا، يمكنك استخدام رمز التحقق أدناه على منصة {{app('settings')->name}} لتفعيل حسابك</p>--}}
                        </div>
                        <!--[if mso]></td></tr></table><![endif]-->
                    </td>
                </tr>
...
{{--                                    <p class="o_text-dark" style="color: #242b3d;margin-top: 0px;margin-bottom: 0px;"><strong>{{$activeCode}}</strong></p>--}}
                                </td>
                            </tr>
                            </tbody>
                        </table>
    ...
    <tr>
        <td class="o_bg-light o_px-xs o_pb-lg o_xs-pb-xs" align="center" style="background-color: #dbe5ea;padding-left: 8px;padding-right: 8px;padding-bottom: 32px;">
            ...
            <table class="o_block-lg" width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" style="max-width: 800px;margin: 0 auto;">
                ...
                <tr>
                    <td class="o_px-md o_py-lg o_br-b" align="center" style="border-radius: 0px 0px 4px 4px;padding-left: 24px;padding-right: 24px;padding-top: 32px;padding-bottom: 32px;">
                        <!--[if mso]><table width="584" cellspacing="0" cellpadding="0" border="0" role="presentation"><tbody><tr><td align="center"><![endif]-->
                        <div class="o_col-6s o_sans o_text-xs o_text-light" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 14px;line-height: 21px;max-width: 584px;color: #82899a;">
                            {{--                            <p class="o_mb" style="margin-top: 0px;margin-bottom: 16px;"><a class="o_text-primary" href="https://example.com/" style="text-decoration: none;outline: none;color: #126de5;"><img src="{{app('settings')->white_logo_url}}" width="36" height="36" alt="SimpleApp" style="max-width: 36px;-ms-interpolation-mode: bicubic;vertical-align: middle;border: 0;line-height: 100%;height: auto;outline: none;text-decoration: none;"></a></p>--}}
{{--                            <p class="o_mb" style="margin-top: 0px;margin-bottom: 16px;">{{app('settings')->copy_rights}}</p>--}}
                            {{--                            <p class="o_mb" style="margin-top: 0px;margin-bottom: 16px;">--}}
                            {{--                                السعودية ,الرياض--}}
                            {{--                            </p>--}}
{{--                            <p style="margin-top: 0px;margin-bottom: 0px;">--}}
{{--                                <a class="o_text-light o_underline" href="https://sin.sa/contact-us" style="text-decoration: underline;outline: none;color: #82899a;">إتصل بنا</a> <span class="o_hide-xs">&nbsp; • &nbsp;</span><br class="o_hide-lg" style="display: none;font-size: 0;max-height: 0;width: 0;line-height: 0;overflow: hidden;mso-hide: all;visibility: hidden;">--}}
{{--                                <a class="o_text-light o_underline" href="https://sin.sa/faqs" style="text-decoration: underline;outline: none;color: #82899a;">الأسئلة الشائعة</a> <span class="o_hide-xs">&nbsp; • &nbsp;</span><br class="o_hide-lg" style="display: none;font-size: 0;max-height: 0;width: 0;line-height: 0;overflow: hidden;mso-hide: all;visibility: hidden;">--}}
{{--                                <a class="o_text-light o_underline" href="https://sin.sa/terms" style="text-decoration: underline;outline: none;color: #82899a;">الشروط والأحكام</a> <span class="o_hide-xs">&nbsp; • &nbsp;</span><br class="o_hide-lg" style="display: none;font-size: 0;max-height: 0;width: 0;line-height: 0;overflow: hidden;mso-hide: all;visibility: hidden;">--}}
{{--                                <a class="o_text-light o_underline" href="https://sin.sa/agreement" style="text-decoration: underline;outline: none;color: #82899a;">اتفاقية المستخدم</a>--}}
{{--                            </p>--}}
                        </div>
                        <!--[if mso]></td></tr></table><![endif]-->
                    </td>
