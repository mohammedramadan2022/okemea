        ...
        <div class="container">
            <div class="row mt-4">
                <div class="col-md-3 col-lg-3 col-xl-3 col-12">
                    <div class="mb-4">
                        <h3 class="font-sm text-secondary letter-spacing-normal">مرحبا بكـ <span>محمد رمضان</span> | <a href="#" class="text-secondary font-sm">تسجيل الخروج</a></h3>
                    </div>
                    <div class="nav flex-column nav-pills me-3 tab-links border-radius-5" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        <a href="{{route('guarantees')}}" class="nav-link px-0 text-secondary bg-acent fw-regular letter-spacing-normal text-start " id="v-pills-home-tab"   >عرض الضمانات السابقة</a>
                        <a href="{{route('personal-information')}}" class="nav-link px-0 text-secondary bg-acent fw-regular letter-spacing-normal text-start" id="profile-tab"   >المعلومات الشخصية</a>
                        <a href="{{route('add-guarantee')}}" class="nav-link px-0 text-secondary bg-acent fw-regular letter-spacing-normal text-start  active" id="add-new-device-tab"   >إضافة جهاز جديد</a>
                    </div>
                </div>
                            ...
                            <div class="add-new-device">
                                <div class="mx-auto">
                                    <div class="card profile-card border-0 text-center">
                                        ...
                                        <div class="form-div">
                                            <form action="{{route('store-guarantee')}}" method="post"  enctype="multipart/form-data">
                                                @csrf
                                                <div class="form-group text-start">
                                                    ...
                                                    <select name="device_id" class="form-control form-select" id="device_id">
                                                        <option selected="true" disabled="disabled" value="">إختر الجهاز</option>
                                                ...
                                                <div class="form-group text-start">
                                                    ...
                                                    <input type="file" id="invoice_image"  name = "invoice_image"class="form-control">
                                                ...
                                                <div class="form-group text-start">
                                                    ...
                                                    <input type="file" id="carton_image" name="carton_image" class="form-control">
                                                    @error('carton_image')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                                <div class="form-group text-start">
                                                    <label class="fw-bold fs-sm mb-1" for="country_id">الدولة</label>
                                                ...
                                                <div class="form-group">
                                                    <button type="submit" class="btn bg-primary text-acent form-control letter-spacing-normal">حفظ</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
