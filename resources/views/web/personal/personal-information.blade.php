                    ...
                    <div class="row d-sm-flex">
                        <div class="col-md-3 col-lg-3 col-xl-3 col-12 order-2-sm d-flex align-items-end pb-4">
                            <form action="" class="verify">
                                <button class="btn bg-primary text-acent letter-spacing-normal fw-bold form-control">
                                    تحقق
                                </button>
                                            ...
                                            <div class="form-group text-start">
                                                ...
                                                <select name="country_id" class="form-control form-select"
                                                    ...
                                                    @foreach($countries as $country)
                                                        <option value="{{$country->id}}" data-country_code="{{$country->country_code}}"
                                                                @if(auth()->user()->city->country_id == $country->id) selected @endif>{{$country->name}}</option>
