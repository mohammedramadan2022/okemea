              ...
              <div class="row">
                <div class="col mega-box">
                  ...
                  <div class="link-section icon">
                    ...
                    <ul>
                      <li><a href="{{route('error-400')}}" target="_blank">Error page 400</a></li>
                      <li><a href="{{route('error-401')}}" target="_blank">Error page 401</a></li>
                      <li><a href="{{route('error-403')}}" target="_blank">Error page 403</a></li>
                      <li><a href="{{route('error-404')}}" target="_blank">Error page 404</a></li>
                      <li><a href="{{route('error-500')}}" target="_blank">Error page 500</a></li>
                      <li><a href="{{route('error-503')}}" target="_blank">Error page 503</a></li>
                    </ul>
                  </div>
                </div>
                <div class="col mega-box">
                  <div class="link-section doted">
                    ...
                    <ul>
                      ...
                      <li><a href="{{route('login-image')}}" target="_blank">Login Bg Image</a></li>
                      <li><a href="{{route('login-video')}}" target="_blank">Login Bg video</a></li>
                      <li><a href="{{route('signup')}}" target="_blank">Register Simple</a></li>
                      <li><a href="{{route('signup-image')}}" target="_blank">Register Bg Image</a></li>
                      <li><a href="{{route('signup-video')}}" target="_blank">Register Bg video</a></li>
                    </ul>
                  </div>
                </div>
                <div class="col mega-box">
                  <div class="link-section dashed">
                    ...
                    <ul>
                      <li><a href="{{route('unlock')}}" target="_blank">Unlock User</a></li>
                      <li><a href="{{route('forget-password')}}" target="_blank">Forget Password</a></li>
                      <li><a href="{{route('reset-password')}}" target="_blank">Reset Password</a></li>
                      <li><a href="{{route('maintenance')}}" target="_blank">Maintenance</a></li>
                    </ul>
                  </div>
                </div>
                <div class="col mega-box">
                  <div class="link-section">
                    ...
                    <ul>
                      <li><a href="{{route('basic-template')}}" target="_blank">Basic Email</a></li>
                      <li><a href="{{route('email-header')}}" target="_blank">Basic With Header</a></li>
                      <li><a href="{{route('template-email')}}" target="_blank">Ecomerce Template</a></li>
                      <li><a href="{{route('template-email-2')}}" target="_blank">Email Template 2</a></li>
                      <li><a href="{{route('ecommerce-templates')}}" target="_blank">Ecommerce Email</a></li>
                      <li><a href="{{route('email-order-success')}}" target="_blank">Order Success</a></li>
                    </ul>
                  </div>
                </div>
                <div class="col mega-box">
                  <div class="link-section">
                    ...
                    <ul class="svg-icon">
                      <li><a href="{{route('comingsoon')}}" target="_blank"> <i data-feather="file"> </i>Coming-soon</a></li>
                      <li><a href="{{route('comingsoon-bg-video')}}" target="_blank"> <i data-feather="film"> </i>Coming-video</a></li>
                      <li><a href="{{route('comingsoon-bg-img')}}" target="_blank"><i data-feather="image"> </i>Coming-Image</a></li>
                    </ul>
                  </div>
                </div>
              </div>
