      ...
      <div id="mainnav">
        <ul class="nav-menu custom-scrollbar">
          ...
          <li class="sidebar-title">
            <div>
              <h6 class="lan-1"> {{ trans('lang.Settings') }}</h6>
            </div>
          </li>
...
{{--            <li class="dropdown"><a class="nav-link menu-title link-nav {{ Illuminate\Support\Str::startsWith(request()->route()->getName(), 'cities.')  ? 'active' : '' }}" href="{{route('cities.index')}}"><i data-feather="cast"> </i><span>{{ trans('lang.Cities') }}</span></a></li>--}}
            ...
            <li class="dropdown"><a class="nav-link menu-title link-nav {{ Illuminate\Support\Str::startsWith(request()->route()->getName(), 'deleted-clients')  ? 'active' : '' }}" href="{{route('deleted-clients')}}"><i data-feather="cast"> </i><span>Deleted Clients </span></a></li>
...
{{--              <label class="badge badge-danger">{{ trans('lang.New') }}</label></span>--}}
...
{{--          <li class="dropdown"><a class="nav-link menu-title link-nav {{ Route::currentRouteName()=='kanban' ? 'active' : '' }}" href="{{route('kanban')}}"><i data-feather="monitor"> </i><span>{{ trans('lang.Kanban Board') }}<label class="badge badge-primary">{{ trans('lang.Latest') }}</label></span></a>--}}
{{--          </li>--}}
{{--          <li class="dropdown">--}}
...
{{--            </ul>--}}
{{--          </li>--}}
{{--          <li class="dropdown"><a class="nav-link menu-title link-nav {{ Route::currentRouteName()=='bookmark' ? 'active' : '' }}" href="{{route('bookmark')}}"><i data-feather="heart"> </i><span>{{ trans('lang.Bookmarks') }}</span></a></li>--}}
{{--          <li class="dropdown"><a class="nav-link menu-title link-nav {{ Route::currentRouteName()=='contacts' ? 'active' : '' }}" href="{{route('contacts')}}"><i data-feather="list"> </i><span>{{ trans('lang.Contacts') }}</span></a></li>--}}
{{--          <li class="dropdown"><a class="nav-link menu-title link-nav {{ Route::currentRouteName()=='task' ? 'active' : '' }}" href="{{route('task')}}"><i data-feather="check-square"> </i><span>{{ trans('lang.Tasks') }}</span></a></li>--}}
{{--          <li class="dropdown"><a class="nav-link menu-title link-nav {{ Route::currentRouteName()=='calendar-basic' ? 'active' : '' }}" href="{{route('calendar-basic')}}"><i data-feather="calendar"> </i><span>{{ trans('lang.Calendar') }}</span></a></li>--}}
{{--          <li class="dropdown"><a class="nav-link menu-title link-nav {{ Route::currentRouteName()=='social-app' ? 'active' : '' }}" href="{{route('social-app')}}"><i data-feather="zap"> </i><span>{{ trans('lang.Social App') }}</span></a></li>--}}
{{--          <li class="dropdown"><a class="nav-link menu-title link-nav {{ Route::currentRouteName()=='to-do' ? 'active' : '' }}" href="{{route('to-do')}}"><i data-feather="clock"> </i><span>{{ trans('lang.To-Do') }}</span></a></li>--}}
{{--          <li class="sidebar-title">--}}
{{--            <div>--}}
...
{{--              <i data-feather="bar-chart"></i><span>{{ trans('lang.Charts') }}</span>--}}
...
{{--            </div>--}}
{{--          </li>--}}
{{--            <li class="dropdown"><a class="nav-link menu-title link-nav {{ Route::currentRouteName()=='cities.index' ? 'active' : '' }}" href="{{route('cities.index')}}"><i data-feather="cast"> </i><span>{{ trans('lang.cities') }}</span></a></li>--}}


{{--            <li class="dropdown"><a class="nav-link menu-title link-nav {{ Route::currentRouteName()=='landing-page' ? 'active' : '' }}" href="{{route('landing-page')}}"><i data-feather="cast"> </i><span>{{ trans('lang.Landing page') }}</span></a></li>--}}


{{--          <li class="dropdown"><a class="nav-link menu-title link-nav {{ Route::currentRouteName()=='sample-page' ? 'active' : '' }}" href="{{route('sample-page')}}"><i data-feather="file-text"> </i><span>{{ trans('lang.Sample page') }}</span></a></li>--}}
{{--          <li class="dropdown"><a class="nav-link menu-title link-nav {{ Route::currentRouteName()=='internationalization' ? 'active' : '' }}" href="{{route('internationalization')}}"><i data-feather="globe"> </i><span>{{ trans('lang.Internationalization') }}</span></a></li>--}}
{{--          <li class="dropdown"><a class="nav-link menu-title link-nav" href="{{route('layout-light')}}" target="_blank"><i data-feather="anchor"></i><span>{{ trans('lang.Starter kit') }}</span></a></li>--}}
{{--          <li class="mega-menu">--}}
{{--            <a class="nav-link menu-title {{request()->route()->getPrefix() == '/others' ? 'active' : '' }}" href="#">--}}
{{--              <i data-feather="layers"></i><span>{{ trans('lang.Others') }}</span>--}}
...
{{--            </ul>--}}
{{--          </li>--}}
{{--          <li class="dropdown"><a class="nav-link menu-title link-nav {{ Route::currentRouteName()=='faq' ? 'active' : '' }}" href="{{route('faq')}}"><i data-feather="help-circle"> </i><span>{{ trans('lang.FAQ') }}</span></a></li>--}}
{{--          <li class="dropdown">--}}
...
{{--            </ul>--}}
{{--          </li>--}}
{{--          <li class="dropdown"><a class="nav-link menu-title link-nav {{ Route::currentRouteName()=='knowledgebase' ? 'active' : '' }}" href="{{route('knowledgebase')}}"><i data-feather="sunrise"> </i><span>{{ trans('lang.Knowledgebase') }}</span></a></li>--}}
{{--          <li class="dropdown"><a class="nav-link menu-title link-nav {{ Route::currentRouteName()=='support-ticket' ? 'active' : '' }}" href="{{route('support-ticket')}}"><i data-feather="users"> </i><span>{{ trans('lang.Support Ticket') }}</span></a></li>--}}
{{--        </ul>--}}
      </div>
