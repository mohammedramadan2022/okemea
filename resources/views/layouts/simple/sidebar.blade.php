      ...
      <div id="mainnav">
        <ul class="nav-menu custom-scrollbar">
          ...
          <li class="sidebar-title">
            ...
            <li class="dropdown"><a class="nav-link menu-title link-nav {{ Route::currentRouteName()=='cities.index' ? 'active' : '' }}" href="{{route('countries.index')}}"><i data-feather="cast"> </i><span>{{ trans('lang.Countries') }}</span></a></li>
