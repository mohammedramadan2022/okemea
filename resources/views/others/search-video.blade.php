         ...
         <div class="card">
            ...
            <div class="card-body">
               <ul class="nav nav-tabs border-tab" id="top-tab" role="tablist">
                  <li class="nav-item">
                     <a class="nav-link" id="all-link" data-toggle="tab" href="#all-links" role="tab" aria-selected="true"><i class="icon-target"></i>All</a>
                  ...
                  <li class="nav-item">
                     <a class="nav-link active" id="video-link" data-toggle="tab" href="#video-links" role="tab" aria-selected="false"><i class="icon-video-clapper"></i>Videos</a>
                     <div class="material-border"></div>
                  </li>
                  <li class="nav-item">
               ...
               <div class="tab-content" id="top-tabContent">
                  ...
                  <div class="tab-pane fade active show" id="video-links" role="tabpanel" aria-labelledby="video-link">
                     <div class="row">
                        <div class="col-xl-6 box-col-12">
                           <p class="pb-4">About 6,000 results (0.60 seconds)</p>
