         ...
         <div class="card">
            ...
            <div class="card-body">
               <ul class="nav nav-tabs border-tab" id="top-tab" role="tablist">
                  <li class="nav-item">
                     <a class="nav-link" id="all-link" data-toggle="tab" href="#all-links" role="tab" aria-selected="false"><i class="icon-target"></i>All</a>
                     <div class="material-border"></div>
                  </li>
                  <li class="nav-item">
                     <a class="nav-link active" id="image-link" data-toggle="tab" href="#image-links" role="tab" aria-selected="true"><i class="icon-image"></i>Images</a>
                     <div class="material-border"></div>
                  </li>
                  <li class="nav-item">
               ...
               <div class="tab-content" id="top-tabContent">
                  <div class="search-links tab-pane fade" id="all-links" role="tabpanel" aria-labelledby="all-link">
                     <div class="row">
                        <div class="col-xl-6">
                  ...
                  <div class="tab-pane fade active show" id="image-links" role="tabpanel" aria-labelledby="image-link">
